...
namespace DevTreks.Models
{
    ...
    {
        public BudgetSystemToInput() { }
        public BudgetSystemToInput(bool init)
        {
            PKId = 0;
            Num = General.NONE;
            Name = General.NONE;
            ...
            BudgetSystemToOperationId = 0;
            BudgetSystemToOperation = new BudgetSystemToOperation(); ;
            InputId = 0;
            InputSeries = new InputSeries();
        }
        public BudgetSystemToInput(BudgetSystemToInput rt)
        {
            PKId = rt.PKId;
            Num = rt.Num;
            Name = rt.Name;
            ...
            BudgetSystemToOperationId = rt.BudgetSystemToOperationId;
            BudgetSystemToOperation = new BudgetSystemToOperation();
            InputId = rt.InputId;
            InputSeries = new InputSeries();
        }
