...
namespace DevTreks.Models
{
    public partial class Outcome
    {
        ...
        public Outcome(bool init)
        {
            ...
            this.OutcomeClassId = 0;
            this.OutcomeClass = new OutcomeClass();
            this.BudgetSystemToOutcome = new List<BudgetSystemToOutcome>();
            this.LinkedViewToOutcome = new List<LinkedViewToOutcome>();
            this.OutcomeToOutput = new List<OutcomeToOutput>();
        }
        public Outcome(Outcome rp)
        {
            this.PKId = rp.PKId;
            this.Num = rp.Num;
            this.Num2 = rp.Num2;
            ...
            this.OutcomeClassId = rp.OutcomeClassId;
            this.OutcomeClass = new OutcomeClass();
            this.BudgetSystemToOutcome = new List<BudgetSystemToOutcome>();
            this.LinkedViewToOutcome = new List<LinkedViewToOutcome>();
            this.OutcomeToOutput = new List<OutcomeToOutput>();
