...
namespace DevTreks.Extensions
{
    ...
    /// </summary>
    public class OCSB1CalculatorAsync : SB1GeneralCalculatorAsync
    {
        //allow base class to perform initialization tasks when 
        //instances of a derived class are created
        public OCSB1CalculatorAsync() { }
        public OCSB1CalculatorAsync(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
        }
        //methods
        ...
        private IEnumerable<XElement> StreamOperationInputs()
        {
        ...
        private IEnumerable<XElement> StreamComponentInputs()
        {
            //not all analyses include inputs, so use ReadToDescendent syntax
            while (this.GCCalculatorParams.DocToCalcReader
