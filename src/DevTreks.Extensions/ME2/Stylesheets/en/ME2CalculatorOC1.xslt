	...
	<xsl:template match="root">
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This tool tracks monitoring and evaluation indicators for operation or component uris. Up to 15 new 
          M and E indicators can be added for each operation or component. 
			</p>
			<p>
