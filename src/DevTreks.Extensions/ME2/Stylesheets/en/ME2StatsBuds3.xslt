...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:if test="(@TME2Name1 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N1" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label1" />&#xA0;<xsl:value-of select="@TME2Date1" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name2 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N2" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label2" />&#xA0;<xsl:value-of select="@TME2Date2" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name3 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N3" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label3" />&#xA0;<xsl:value-of select="@TME2Date3" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name4 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N4" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label4" />&#xA0;<xsl:value-of select="@TME2Date4" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name5 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N5" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label5" />&#xA0;<xsl:value-of select="@TME2Date5" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name6 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N6" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label6" />&#xA0;<xsl:value-of select="@TME2Date6" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name7 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N7" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label7" />&#xA0;<xsl:value-of select="@TME2Date7" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name8 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N8" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label8" />&#xA0;<xsl:value-of select="@TME2Date8" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name9 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N9" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label9" />&#xA0;<xsl:value-of select="@TME2Date9" />
			  </td>
		  </tr>
			<tr>
        <td>
    ...
    <xsl:if test="(@TME2Name10 != '')">
      <tr>
          ...
          <br />
          <strong>Observations: </strong><xsl:value-of select="@TME2N10" />&#xA0;:&#xA0;<xsl:value-of select="@TME2Label10" />&#xA0;<xsl:value-of select="@TME2Date10" />
			  </td>
		  </tr>
			<tr>
        <td>
