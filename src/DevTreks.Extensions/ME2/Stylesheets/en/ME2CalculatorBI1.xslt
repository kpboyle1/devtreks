	...
	<xsl:template match="root">
      ...
      <xsl:choose>
        <xsl:when test="(contains($docToCalcNodeName, 'budget')
              or contains($docToCalcNodeName, 'investment')
				...
				<xsl:otherwise>
					<h3>This budget/investment calculator does not appear appropriate for the document being calculated. Are you 
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
					This tool tracks monitoring and evaluation indicators for budget or investment uris. Up to 20 new 
          M and E indicators can be added for each budget or investment. 
			</p>
			<p>
