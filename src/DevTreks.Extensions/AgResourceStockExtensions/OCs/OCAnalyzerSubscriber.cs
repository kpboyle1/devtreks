...
namespace DevTreks.Extensions
{
    ...
    ///NOTES        1. 
    /// </summary>
    public class OCAnalyzerSubscriber : OperationComponentCalculator
    {
        //constructors
        ...
        private bool RunStatisticalCalculation(ref XElement currentElement)
        {
            ...
            bHasCalculations = RunOperationComponentStatistic(ref currentElement);
            if (!bHasCalculations
        ...
        private bool RunOperationComponentStatistic(ref XElement currentElement)
        {
