...
namespace DevTreks.Extensions
{
    ...
    ///             
    /// </summary>
    public class GeneralCalculatorAsync
    {
        //allow base class to perform initialization tasks when 
        //instances of a derived class are created
        protected GeneralCalculatorAsync() { }
        protected GeneralCalculatorAsync(CalculatorParameters calcParameters)
        {
        ...
        //                                this.GCCalculatorParams.Updates, sErrorMsg);
        //                            if (i == 0)
        //                            {
