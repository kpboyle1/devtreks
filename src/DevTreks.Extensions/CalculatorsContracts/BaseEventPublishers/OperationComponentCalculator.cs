...
namespace DevTreks.Extensions
{
    ...
    ///             
    /// </summary>
    public class OperationComponentCalculator : GeneralCalculator
    {
        //allow base class to perform initialization tasks when 
        //instances of a derived class are created
        protected OperationComponentCalculator() { }
        protected OperationComponentCalculator(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
        }
