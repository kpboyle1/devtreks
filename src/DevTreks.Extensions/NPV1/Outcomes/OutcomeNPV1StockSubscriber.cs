...
namespace DevTreks.Extensions
{
    ...
    ///NOTES        1. 
    /// </summary>
    public class OutcomeNPV1StockSubscriber : OutcomeCalculator
    {
        //constructors
        public OutcomeNPV1StockSubscriber() { }
        //constructor sets class (base) properties
        public OutcomeNPV1StockSubscriber(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
            if (calcParameters.RelatedCalculatorsType
                == NPV1CalculatorHelper.CALCULATOR_TYPES.npv.ToString())
            {
                this.NPV1StockCalculator = new OutcomeNPV1StockCalculator(calcParameters);
            }
        }

        //properties
        //stateful calculators that can be run by this extension
        public OutcomeNPV1StockCalculator NPV1StockCalculator { get; set; }
