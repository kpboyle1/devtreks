...
namespace DevTreks.Extensions
{
    ...
    ///NOTES        1. 
    public class HealthCareCost2Calculator : Input
    {
        public HealthCareCost2Calculator()
            : base()
        {
            //health care cost object
            InitHealthCareCost2Properties();
        }
        //copy constructor
        public HealthCareCost2Calculator(HealthCareCost2Calculator healthCost1)
            : base(healthCost1)
        {
            CopyHealthCareCost2Properties(healthCost1);
        }
...
//better if generic indicator
        ...
        public virtual void InitHealthCareCost2Properties()
        {
        ...
        public virtual void CopyHealthCareCost2Properties(
            HealthCareCost2Calculator calculator)
        {
        ...
        public virtual void SetHealthCareCost2Properties(CalculatorParameters calcParameters,
            XElement calculator, XElement currentElement)
        {
            SetInputProperties(calcParameters, calculator,
                currentElement);
            SetHealthCareCost2Properties(calculator);
        }
        //set the class properties using the XElement
        public virtual void SetHealthCareCost2Properties(XElement currentCalculationsElement)
        {
        ...
        public virtual void SetHealthCareCost2Properties(string attName,
            string attValue)
        {
            switch (attName)
            {
        ...
        public void SetHealthCareCost2Attributes(string attNameExtension,
        ...
        public virtual void SetHealthCareCost2Attributes(string attNameExtension,
        ...
        public bool RunHCCalculations(CalculatorParameters calcParameters, 
            HealthCareCost2Calculator hcCost1)
        {
            bool bHasCalculations = false;
            if (hcCost1 != null)
            {
                hcCost1.AdjustedPrice = hcCost1.BasePrice * (hcCost1.BasePriceAdjustment / 100);
                HealthCareCost2Calculator.HC1PRICE_TYPE eHC1PriceType
                    = HealthCareCost2Calculator.GetHC1PriceType(hcCost1.HC1PriceType);
                hcCost1.HC1PriceType = eHC1PriceType.ToString();
                if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.adjustedprice)
                {
                    CalculateHealthCareCosts(calcParameters, hcCost1, hcCost1.AdjustedPrice);
                }
                else if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.baseprice)
                {
                    CalculateHealthCareCosts(calcParameters, hcCost1, hcCost1.BasePrice);
                }
                else if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.contractedprice)
                {
                    CalculateHealthCareCosts(calcParameters, hcCost1, hcCost1.ContractedPrice);
                }
                else if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.listprice)
                {
                    CalculateHealthCareCosts(calcParameters, hcCost1, hcCost1.ListPrice);
                }
                else if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.marketprice)
                {
                    CalculateHealthCareCosts(calcParameters, hcCost1, hcCost1.MarketPrice);
                }
                else if (eHC1PriceType == HealthCareCost2Calculator.HC1PRICE_TYPE.productioncostprice)
                {
        ...
        private void CalculateHealthCareCosts(CalculatorParameters calcParameters,
            HealthCareCost2Calculator hcCost1, double fee)
        {
        ...
        private void FixSelections(HealthCareCost2Calculator hcCost1)
        {
        ...
        private void SetCostRating(HealthCareCost2Calculator hcCost1)
        {
            double dbBCRating = 0;
            int iDivisor = 0;
