...
namespace DevTreks.Extensions
{
    ...
    /// </summary>
    public class HC1DevPacksSubscriber : GeneralCalculator
    {
        //constructors
        public HC1DevPacksSubscriber() { }
        //constructor sets class (base) properties
        public HC1DevPacksSubscriber(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
        }
        ...
        public void AddDevPackCalculations(object sender, CustomEventArgs e)
        {
            ...
            HCCalculatorHelper fnCalculatorHelper
                = new HCCalculatorHelper(e.CalculatorParams);
