...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="root">
      ...
      <h4 class="ui-bar-b">
			...
			<p>
					...
					<br />
          This tool calculates life cycle cost totals for input uris. 
							The discounted totals can include up to 10 subcosts and impacts. 
              SubCosts for building investments might include power, electricity, taxes, repairs, maintenance, and contingency.
              SubCosts for health care investments might include copays, deductibles, premiums, fees, travel, lost wages, and household repairs.
							Impacts, such as environmental impacts, can be taken from associated life cycle analyses or other calculators.  
          <br />
          The calculator updates the base input's OCPrice, AOHPrice, and CAPPrice with the calculated totals. 
    ...
    <div id="divsteptwo">
      ...
      <h4 class="ui-bar-b"><strong>SubCosts and Impacts</strong></h4>
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 1</strong></h4>
        <div>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 2</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType2" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType2 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType2 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType2 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
          ...
          <div class="ui-block-a">
            <label for="SubPOtherType1">Price Basis Type 2 </label>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 3</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType3" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType3 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType3 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType3 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 4</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType4" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType4 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType4 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType4 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true"> 
        <h4 class="ui-bar-b"><strong>SubCost 5</strong></h4>
        <div>
      ...
      <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType5" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType5 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType5 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType5 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
						</select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 6</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType6" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType6 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType6 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType6 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 7</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType7" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType7 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType7 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType7 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 8</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType8" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType8 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType8 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType8 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 9</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType9" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType9 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType9 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType9 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d" data-mini="true">
        <h4 class="ui-bar-b"><strong>SubCost 10</strong></h4>
        <div>
        ...
        <div class="ui-grid-a">
          <div class="ui-block-a">
            ...
            <select id="SubPType10" data-mini="true">
              ...
              <option>
                <xsl:attribute name="value">oc</xsl:attribute>
                <xsl:if test="(@SubPType10 = 'oc')">
                  <xsl:attribute name="selected" />
                </xsl:if>operating
              </option>
              <option>
                <xsl:attribute name="value">aoh</xsl:attribute>
                <xsl:if test="(@SubPType10 = 'aoh')">
                  <xsl:attribute name="selected" />
                </xsl:if>overhead
              </option>
              <option>
                <xsl:attribute name="value">cap</xsl:attribute>
                <xsl:if test="(@SubPType10 = 'cap')">
                  <xsl:attribute name="selected" />
                </xsl:if>capital
              </option>
            </select>
   ...
   <div id="divstepfour">
      ...
      <div data-role="collapsible"  data-theme="b" data-content-theme="d">
			<h4>Step 2</h4>
			<ul data-role="listview">
				<li><strong>Step 2. SubCosts: </strong> Up to 10 subcosts can be defined. These definitions refer to these subcosts as LCA elements.</li>
