...
namespace DevTreks.Extensions
{
    ...
    /// </summary>
    public class BILCA1StockCalculator : BudgetInvestmentCalculator
    {
        ...
        public bool SetBIGroupLCA1Calculations(ref XElement currentCalculationsElement,
        ...
        public bool SetBILCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
        ...
        public bool SetTimePeriodLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOCGroupLCA1Calculations(ref XElement currentCalculationsElement,
          ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOpOrCompLCA1Calculations(ref XElement currentCalculationsElement,
           ref XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOutcomeGroupLCA1Calculations(ref XElement currentCalculationsElement,
          ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOutcomeLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetInputGroupLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetInputLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetInputSeriesLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostInputs
        ...
        public bool SetTechInputLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostInputs
        ...
        public bool SetOutputGroupLCA1Calculations(ref XElement currentCalculationsElement,
             ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent budget group for holding collection of budgets
        ...
        public bool SetOutputLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
        ...
        public bool SetOutputSeriesLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostOutputs
        ...
        public bool SetTechOutputLCA1Calculations(ref XElement currentCalculationsElement,
            ref XElement currentElement)
        {
            bool bHasCalculations = false;
            //set the parent opcomp for holding collection of mandECostOutputs
            ...
            ref XElement currentElement, ref XElement currentCalculationsElement)
        {
            ...
            if (!bHasUpdatedCurrentCalcsElement)
            {
                ...
                calc.SetDescendantLCA1StockAttributes(attNameExt, ref lv);
            ...
            ref XElement currentElement, ref XElement currentCalculationsElement)
        {
            ...
            if (currentCalculationsElement != null)
            {
                    ...
                    || this.GCCalculatorParams.RelatedCalculatorsType == sRelatedCalculatorsType))
                {
                    ...
                    calc.SetDescendantLCA1StockAttributes(attNameExt, ref currentCalculationsElement);
                }
                else
                {
