...
namespace DevTreks.Extensions
{
    ...
    /// </summary>
    public class DevPacksLCA1Subscriber : GeneralCalculator
    {
        //constructors
        public DevPacksLCA1Subscriber() { }
        //constructor sets class (base) properties
        public DevPacksLCA1Subscriber(CalculatorParameters calcParameters)
            : base(calcParameters)
        {
        }
        ...
        public void AddDevPackCalculations(object sender, CustomEventArgs e)
        {
            ...
            LCA1CalculatorHelper fnCalculatorHelper
                = new LCA1CalculatorHelper(e.CalculatorParams);
