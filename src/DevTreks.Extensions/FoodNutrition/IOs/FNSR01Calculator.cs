...
namespace DevTreks.Extensions
{
    ...
    public class FNSR01Calculator : Input
    {
        public FNSR01Calculator()
            : base()
        {
            //food fact
            InitFNSR01Properties();
        }
        //copy constructor
        public FNSR01Calculator(FNSR01Calculator foodSR)
            : base(foodSR)
        {
            //food fact
            CopyFNSR01Properties(foodSR);
        }
        ...
        //**********************************
        //might want to deemphasize actual serving size calc
        //if the input's amount is being changed in the operation
        //so that each household member's amount can be figured
        //then typical serving size should be used and NO change
        //in amount entered????

        //calculator properties
        //derived from caprice
        public double MarketValue { get; set; }
        //must be entered manually
        public double ContainerSizeUsingServingSizeUnit { get; set; }
        ...
        public string FoodSourceActual { get; set; }
        public string FoodSourcePreferred { get; set; }
        //alternative type (Accepted updates base.Prices)
        public string AlternativeType { get; set; }
        //is base, or benchmark, case (reference to compare project alternatives, or m&e results)
        public string IsBaseCase { get; set; }
        ...
        private const string cContainerSizeUsingServingSizeUnit = "ContainerSizeUsingServingSizeUnit";
        private const string cServingCost = "ServingCost";
        private const string cActualServingSize = "ActualServingSize";
        private const string cWeightToUseType = "WeightToUseType";
        private const string cTypicalServingSize = "TypicalServingSize";
        private const string cServingSizeUnit = "ServingSizeUnit";
        private const string cSRLabel = "SRLabel";
        private const string cSRDescription = "SRDescription";
        private const string cTypicalServingsPerContainer = "TypicalServingsPerContainer";
        private const string cActualServingsPerContainer = "ActualServingsPerContainer";

        private const string cWater_g = "Water_g";
        private const string cEnerg_Kcal = "Energ_Kcal";
        private const string cProtein_g = "Protein_g";
        private const string cLipid_Tot_g = "Lipid_Tot_g";
        private const string cAsh_g = "Ash_g";
        private const string cCarbohydrt_g = "Carbohydrt_g";
        private const string cFiber_TD_g = "Fiber_TD_g";
        private const string cSugar_Tot_g = "Sugar_Tot_g";
        private const string cCalcium_mg = "Calcium_mg";
        private const string cIron_mg = "Iron_mg";
        private const string cMagnesium_mg = "Magnesium_mg";
        private const string cPhosphorus_mg = "Phosphorus_mg";
        private const string cPotassium_mg = "Potassium_mg";
        private const string cSodium_mg = "Sodium_mg";
        private const string cZinc_mg = "Zinc_mg";
        private const string cCopper_mg = "Copper_mg";
        private const string cManganese_mg = "Manganese_mg";
        private const string cSelenium_pg = "Selenium_pg";
        private const string cVit_C_mg = "Vit_C_mg";
        private const string cThiamin_mg = "Thiamin_mg";
        private const string cRiboflavin_mg = "Riboflavin_mg";
        private const string cNiacin_mg = "Niacin_mg";
        private const string cPanto_Acid_mg = "Panto_Acid_mg";
        private const string cVit_B6_mg = "Vit_B6_mg";
        private const string cFolate_Tot_pg = "Folate_Tot_pg";
        private const string cFolic_Acid_pg = "Folic_Acid_pg";
        private const string cFood_Folate_pg = "Food_Folate_pg";
        private const string cFolate_DFE_pg = "Folate_DFE_pg";
        private const string cCholine_Tot_mg = "Choline_Tot_mg";
        private const string cVit_B12_pg = "Vit_B12_pg";
        private const string cVit_A_IU = "Vit_A_IU";
        private const string cVit_A_RAE = "Vit_A_RAE";
        private const string cRetinol_pg = "Retinol_pg";
        private const string cAlpha_Carot_pg = "Alpha_Carot_pg";
        private const string cBeta_Carot_pg = "Beta_Carot_pg";
        private const string cBeta_Crypt_pg = "Beta_Crypt_pg";
        private const string cLycopene_pg = "Lycopene_pg";
        private const string cLut_Zea_pg = "Lut_Zea_pg";
        private const string cVit_E_mg = "Vit_E_mg";
        private const string cVit_D_pg = "Vit_D_pg";
        private const string cViVit_D_IU = "ViVit_D_IU";
        private const string cVit_K_pg = "Vit_K_pg";
        private const string cFA_Sat_g = "FA_Sat_g";
        private const string cFA_Mono_g = "FA_Mono_g";
        private const string cFA_Poly_g = "FA_Poly_g";
        private const string cCholestrl_mg = "Cholestrl_mg";
        ...
        public virtual void InitFNSR01Properties()
        {
            //avoid null references to properties
            this.MarketValue = 0;
            this.ContainerSizeUsingServingSizeUnit = 0;
            this.ServingCost = 0;
        ...
        public virtual void CopyFNSR01Properties(
            FNSR01Calculator calculator)
        {
            this.MarketValue = calculator.MarketValue;
            this.ContainerSizeUsingServingSizeUnit = calculator.ContainerSizeUsingServingSizeUnit;
        ...
        public virtual void SetFNSR01Properties(CalculatorParameters calcParameters,
            XElement calculator, XElement currentElement)
        {
            ...
            SetFNSR01Properties(calculator);
        }
        //set the class properties using the XElement
        public virtual void SetFNSR01Properties(XElement currentCalculationsElement)
        {
            ...
            this.ContainerSizeUsingServingSizeUnit = CalculatorHelpers.GetAttributeDouble(currentCalculationsElement, cContainerSizeUsingServingSizeUnit);
        ...
        public virtual void SetFNSR01Properties(string attName,
            string attValue)
        {
            switch (attName)
            {
                case cMarketValue:
                    ...
                    break;
                case cContainerSizeUsingServingSizeUnit:
                    this.ContainerSizeUsingServingSizeUnit = CalculatorHelpers.ConvertStringToDouble(attValue);
                    break;
                case cServingCost:
        ...
        public void SetFNSR01Attributes(string attNameExtension,
            ref XElement currentCalculationsElement)
        {
            ...
            CalculatorHelpers.SetAttributeDoubleF3(currentCalculationsElement,
                string.Concat(cContainerSizeUsingServingSizeUnit, attNameExtension), this.ContainerSizeUsingServingSizeUnit);
            CalculatorHelpers.SetAttributeDoubleF3(currentCalculationsElement,
        ...
        public virtual void SetFNSR01Attributes(string attNameExtension,
           ref XmlWriter writer)
        {
            writer.WriteAttributeString(string.Concat(cMarketValue, attNameExtension), this.MarketValue.ToString());
            writer.WriteAttributeString(string.Concat(cContainerSizeUsingServingSizeUnit, attNameExtension), this.ContainerSizeUsingServingSizeUnit.ToString());
