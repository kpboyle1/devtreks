...
{
    /// <summary>
    ///Purpose:		EF dbcontext and initial models generated by running the following with rc2 binaries
    ///             Scaffold-DbContext "'Server=.\SQLEXP2016RC1;Database=DevTreksDesk;Trusted_Connection=True;'" Microsoft.EntityFrameworkCore.SqlServer
    ...
    public partial class DevTreksContext : DbContext
    {
        ...
        //    optionsBuilder.UseSqlServer(@"Server=.\SQLEXP2016RC1;Database=DevTreksDesk;Trusted_Connection=True;");
        //}
