...
namespace DevTreks.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160401184342_DTMigrate1")]
    partial class DTMigrate1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            modelBuilder
                .HasAnnotation("ProductVersion", "1.0.0-rc2-final")
                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

            modelBuilder.Entity("DevTreks.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DevTreks.Models.ApplicationUser")
                        .WithMany()
